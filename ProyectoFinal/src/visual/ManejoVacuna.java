...
public class ManejoVacuna extends JDialog {
    ...
    public ManejoVacuna() {
        ...
        panelRegistro.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"),
                "Registro de Vacuna", TitledBorder.CENTER, TitledBorder.TOP, new Font("Tahoma", Font.BOLD, 13), Color.WHITE));
        ...
        lblEdadMin.setFont(new Font("Tahoma", Font.BOLD, 13));
